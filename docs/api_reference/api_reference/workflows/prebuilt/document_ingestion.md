...
=== "pip"
    ...
    ```bash
    $ pip install "donkey-workflows[prebuilt]"
    ```

=== "uv"

    ```bash
    $ uv add "donkey-workflows[prebuilt]"
    ```
...
from donkey.loaders import DirectoryLoader
from donkey.text_chunkers import TokenChunker
from donkey.vector_stores import ChromaVectorStore
from donkey.embeddings import HuggingFaceEmbeddings
...
Full workflow documentation [here](https://donkey-project.github.io/donkey/workflows/overview/)