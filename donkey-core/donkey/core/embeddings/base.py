...
import numpy as np
from donkey.core.bridge.pydantic import Field
from donkey.core.components import TransformerComponent
from donkey.core.document import Document
from donkey.core.enums import SimilarityMode
from donkey.core.instrumentation import DispatcherSpanMixin, get_dispatcher
from donkey.core.instrumentation.events.embedding import (
    EmbeddingEndEvent,
    EmbeddingStartEvent,
)
