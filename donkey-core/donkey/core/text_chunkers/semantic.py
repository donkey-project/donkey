...
from donkey.core.embeddings import BaseEmbedding
from donkey.core.embeddings.base import similarity
from donkey.core.enums import SimilarityMode
from donkey.core.text_chunkers.base import BaseTextChunker
...
class SemanticChunker(BaseTextChunker):
    ...
    Example:
        ```python
        from donkey.core.text_chunker import SemanticChunker
        from donkey.embedding.huggingface import HuggingFaceEmbedding
