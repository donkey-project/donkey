...
class TokenTextChunker(BaseTextChunker):
    ...
    Example:
        ```python
        from donkey.core.text_chunker import TokenTextChunker
    ...
    def _get_text_chunks(self, text: str) -> list[str]:
        ...
        Example:
            ...
            chunks = text_chunker.get_text_chunks(
                "donkey is a data framework to load any data in one line of code and connect with AI applications."
            )
            ```
        """
