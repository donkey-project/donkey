from donkey_instrumentation.dispatcher import Dispatcher, DispatcherManager
...
def set_global_handler(handler: BaseObservability) -> None:
    ...
    Example:
        ```python
        from donkey_instrumentation import set_global_handler, get_dispatcher
        from donkey_instrumentation.observability import ConsoleObservability
