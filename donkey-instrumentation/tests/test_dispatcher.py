...
import donkey_instrumentation as instrumentation
import pytest
import wrapt
from donkey_instrumentation import DispatcherSpanMixin
from donkey_instrumentation.dispatcher import Dispatcher, _context_metadata
from donkey_instrumentation.events import BaseEvent
from donkey_instrumentation.observability import BaseObservability
...
@patch("donkey_instrumentation.dispatcher.uuid")
