...
from donkey.core.guardrails import BaseGuardrail, GuardrailResponse
from donkey.core.guardrails.enums import Direction
from donkey.core.toolkit import validate_enum
from donkey.core.toolkit.http import HttpService
from donkey.core.toolkit.http.authenticators import IBMIAMAuthenticator
from donkey.guardrails.watsonx.supporting_classes.enums import Region
...
class WatsonxGuardrail(BaseGuardrail):
    ...
    Example:
        ```python
        from donkey.guardrails.watsonx import (
            WatsonxGuardrail,
        )
