...
from donkey.observability.watsonx.client import (
    WatsonxGovClient,
)
from donkey.observability.watsonx.enums import Region
...
class WatsonxObservability(BaseObservability):
    """
    Add observability to Donkey LLM Calls with IBM watsonx.governance.
    ...
    Example:
        ...
        from donkey.observability.watsonx import WatsonxObservability
