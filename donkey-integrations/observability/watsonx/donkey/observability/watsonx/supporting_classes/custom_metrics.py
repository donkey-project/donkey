...
from donkey.observability.watsonx.enums import DataSetType
...
from donkey.observability.watsonx.supporting_classes.utils import suppress_output
...
class CustomMetrics(BaseModel):
    ...
    def _add_integrated_system(
        ...
        custom_metrics_integrated_system = self.wos_client.integrated_systems.add(
            name=name,
            description="Integrated system created by Donkey.",
