...
from donkey.core.document import Document, DocumentWithScore
...
class ElasticsearchVectorStore(BaseVectorStore):
    ...
    Example:
        ...
        from donkey.vector_stores.elasticsearch import ElasticsearchVectorStore

        embedding = HuggingFaceEmbedding()
        es_vector_store = ElasticsearchVectorStore(
            index_name="donkey-index",
    ...
    def _create_index_if_not_exists(self) -> None:
        ...
        if self._client.indices.exists(index=self.index_name):
            ...
            dims_length = len(
                self.embed_model.embed_text("donkey-vector-stores-elasticsearch")
            )
